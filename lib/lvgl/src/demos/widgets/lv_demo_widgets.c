...
static void analytics_create(lv_obj_t * parent)
{
    ...
    lv_chart_series_t *ser2 = lv_chart_add_series(chart1, lv_palette_main(LV_PALETTE_LIME), LV_CHART_AXIS_SECONDARY_Y);
    uint32_t i;
    for(i = 0; i < 12; i++) {
        lv_chart_set_next_value(chart1, ser1, lv_rand(10, 80));
        lv_chart_set_next_value(chart1, ser2, lv_rand(10, 80));
    }
